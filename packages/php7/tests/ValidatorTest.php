<?php
/**
 * Tests for SemanticSyntax Validator (PHP 7.4)
 *
 * This suite validates the behavior of the strict-typed Validator class.
 * It ensures API consistency with the legacy PHP 5.6 package and forward-compatibility
 * with the PHP 8.1+ package. Part of the SemanticSyntax brand: code that makes sense.
 *
...
final class ValidatorTest extends TestCase
{
    ...
    {
        self::assertTrue(Validator::int(10, 1, 100));
